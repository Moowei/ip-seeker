...
//                    entry.parseCountry = ipLoc.getCountry();
//                    entry.originArea = ipLoc.getArea();
//                    // 得到起始IP
//                    readIP(offset - 4, b4);
//                    entry.originBeginIp = Util.getIpStringFromBytes(b4);
//                    // 得到结束IP
//                    readIP(temp, b4);
//                    entry.originEndIp = Util.getIpStringFromBytes(b4);
//                    // 添加该记录
//                    ret.add(entry);
                }
            }
...
//                        IPEntry entry = new IPEntry();
//                        entry.parseCountry = ipLoc.getCountry();
                        ipEntryInstance.setParseCountry(ipLoc.getCountry());
//                        entry.originArea = ipLoc.getArea();
                        ipEntryInstance.setOriginArea(ipLoc.getArea());
                        // 得到起始IP
                        readIP(offset - 4, b4);
//                        entry.originBeginIp = Util.getIpStringFromBytes(b4);
                        ipEntryInstance.setOriginBeginIp(Util.getIpStringFromBytes(b4));
                        // 得到结束IP
                        readIP(temp, b4);
//                        entry.originEndIp = Util.getIpStringFromBytes(b4);
                        ipEntryInstance.setOriginEndIp(Util.getIpStringFromBytes(b4));
                        // 添加该记录
//                        ret.add(entry);
                        ret.add(ipEntryInstance);
                    }
                }
            }
        } catch (IOException e) {
